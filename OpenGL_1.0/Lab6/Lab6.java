...
/**
 * CSCI 480, Sp 2022, Lab 6:  Image Textures in OpenGL/JOGL.
 ...
 */
public class Lab6 extends JPanel implements GLEventListener {

	/**
	 * Main routine allows this class to be run as an application.
	 * It creates a JFrame, sets its content pane to be a Lab6 panel,
	...
	private void triangularPrism(GL2 gl2) {
		...
		gl2.glTexCoord2d(1.0, 0.6);
		gl2.glVertex3d(-t,-0.5,-0.25);
		gl2.glTexCoord2d(0.0, 0.6);
		gl2.glVertex3d(-t,0.5,-0.25);
